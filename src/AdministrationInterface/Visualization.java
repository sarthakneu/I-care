...
public class Visualization extends javax.swing.JPanel {
    ...
    public Visualization(MainJFrameForm MainLPage, DB4 dB4OUtility, Operatesys operatingSystem) {
        initComponents();
    ...
    private ChartPanel chartPanelNameEntity() {
        ...
        for(DonationAssignment dasn: operatingSystem.getDonationAssignList()){

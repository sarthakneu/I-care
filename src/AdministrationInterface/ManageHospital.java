...
public class ManageHospital extends javax.swing.JPanel {
    ...
    public ManageHospital(MainJFrameForm MainLPage, DB4 dB4OUtility, Operatesys operatingSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jScrollPaneDoctor.setViewportView(table2);
    ...
    private void getdetails_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getdetails_btnActionPerformed
        ...
        if (selectedRow < 0) {
            JOptionPane.showMessageDialog(this, "Please Select a row to get details.");
            return;
        }
        ...
        populateDoctorTable(operatingSystem.getDocDirectory(), hospitalName);
        populatePatientTable(operatingSystem.getPatiDirectory(), hospitalName);
    ...
    private void populateDoctorTable(ArrayList<Doc> doctors, String hosp) {
        ...
        for (Doc d : doctors) {
            ...
            Object[] row = new Object[5];
            if (d.getHospiName().equals(hosp)) {

                row[0] = d.getPersoname();
                row[1] = d.getUseName();
                row[2] = d.getHospiName();
                row[3] = d.getAddress();
                model.addRow(row);
            }
        }

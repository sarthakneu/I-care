...
public class ProfileDetailsDonor extends javax.swing.JPanel {
    ...
    public ProfileDetailsDonor(MainJFrameForm MainLPage, DB4 dB4OUtility, Operatesys operatingSystem, DonorUser don) {
        initComponents();
        ...
        txtName.setText(don.getPersoname());
        txtUName.setText(don.getUseName());
        txtAddHosp.setText(don.getAddress());
        txtTeleName.setText(don.getPhoneNum());

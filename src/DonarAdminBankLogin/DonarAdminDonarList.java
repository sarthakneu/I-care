...
public class DonarAdminDonarList extends javax.swing.JPanel {
    ...
    public DonarAdminDonarList(MainJFrameForm MainLPage, DB4 dB4OUtility, Operatesys operatingSystem, DonorBank donbank) {
        initComponents();
    ...
    private void populateTable() {
        ...
        for (DonorUser d : operatingSystem.getDonorDirectory()) {
            System.out.println("populatetable " + d.getUseName());

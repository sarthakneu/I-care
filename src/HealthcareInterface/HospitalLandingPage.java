...
public class HospitalLandingPage extends javax.swing.JPanel {
    ...
    public HospitalLandingPage(MainJFrameForm MainLPage, DB4 dB4OUtility, Operatesys operatingSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(cmbxRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 180, 220, 40));

        lbUsername.setBackground(new java.awt.Color(0, 0, 0));
        lbUsername.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbUsername.setText("Username:");
        jPanel1.add(lbUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 90, 30));
        ...
        jPanel1.add(lbHealthcare, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 240, 60));
        jPanel1.add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 190, 220, 40));

        lbPassword.setBackground(new java.awt.Color(0, 0, 0));
        lbPassword.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbPassword.setText("Password:");
        jPanel1.add(lbPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 80, 30));
        jPanel1.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 260, 220, 40));
        ...
        jPanel1.add(btLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, 220, 40));
        ...
        jPanel1.add(btSignUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 260, 220, 40));
        ...
        jPanel1.add(lbRoleName, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 190, 170, 30));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HealthcareInterface/healthcare1.jpg"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1290, 740));
